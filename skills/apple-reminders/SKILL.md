---
name: apple-remindersdescription: "Управление Apple Reminders через remindctl CLI (просмотр, добавление, редактирование, завершение, удаление). Поддерживает списки, фильтры по дате и вывод в форматах JSON/plain."
