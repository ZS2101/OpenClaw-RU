---
name: coding-agentdescription: "'Делегирование задач по программированию агентам Codex, Claude Code или Pi через фоновый процесс. Используйте для: (1) создания новых функций или приложений, (2) ревью PR (запуск во временной директории), (3) рефакторинга крупных кодовых баз, (4) итеративного написания кода с необходимостью изучения файлов. NOT for: simple one-liner fixes (just edit), reading code (use read tool), thread-bound ACP harness requests in chat (for example spawn/run Codex or Claude Code in a Discord thread; use sessions_spawn with runtime:"acp"), or any work in ~/clawd workspace (never spawn agents here). Claude Code: use --print --permission-mode bypassPermissions (no PTY). Codex/Pi/OpenCode: pty:true required.'"
metadata:
  {
    "openclaw":
      {
