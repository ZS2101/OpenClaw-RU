---
name: waclidescription: "Отправка сообщений WhatsApp другим людям или поиск/синхронизация истории WhatsApp через wacli CLI (не для обычных пользовательских чатов)."
