...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      "Хуки позволяют автоматизировать действия при вызове команд агента.",
      "Пример: Сохранение контекста сессии в память при вызове /new или /reset.",
      "",
  ...
  await prompter.note(
    [
      ...
      "",
      "Вы можете управлять хуками позже с помощью:",
