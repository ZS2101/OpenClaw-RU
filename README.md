...
- **Погода**:  текущая погода и прогноз (почасовой, дневной).
  ...
  **Новые скиллы**
  - **hh.ru**: поиск/размещение вакансий, переписка с работадателем/соискателем, отклик на вакансии итд (OAuth2). 
  - **kinopoisk**: - поиск фильмов, сериалов, актеров, рейтингов (бесплатный токен с kinopoiskapiunofficial.tech/signup0).
---

## Русификация

- **CLI:** баннер, 60+ тэглайнов на русском, визард + пасхалка на 9 мая
