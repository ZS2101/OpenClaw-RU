...
## Недоработки
Баги:
- **YandexCloud:** на данный момент каталог моделей не загружается автоматически, wizard запрашивает folder id отдельным шагом. Исправлено в коде, ждёт ближайшего релиза.
