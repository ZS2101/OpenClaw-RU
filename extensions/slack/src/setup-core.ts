...
export function createSlackSetupWizardBase(handlers: {
  ...
  return {
    ...
    status: createStandardChannelSetupStatus({
      ...
      unconfiguredLabel: "нужны токены",
      configuredHint: "настроено",
      unconfiguredHint: "нужны токены",
      configuredScore: 2,
      unconfiguredScore: 1,
