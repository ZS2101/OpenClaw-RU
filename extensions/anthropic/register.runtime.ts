    ...
    auth: [
      {
        ...
        wizard: {
          ...
          choiceHint: "Использовать локальный логин Claude CLI на этом хосте",
          assistantPriority: -20,
          groupId: "anthropic",
          groupLabel: "$ Anthropic",
          groupSortKey: 3,
          groupHint: "Claude CLI + API-ключ",
          modelAllowlist: {
      ...
      },
      {
        ...
        wizard: {
          ...
          choiceLabel: "Setup-токен Anthropic",
          choiceHint: "Путь к токену вручную",
          assistantPriority: 40,
          groupId: "anthropic",
          groupLabel: "$ Anthropic",
          groupSortKey: 3,
          groupHint: "Claude CLI + API-ключ + токен",
        },
      ...
      createProviderApiKeyAuthMethod({
        ...
        promptMessage: "Введите API-ключ Anthropic",
        defaultModel: defaultAnthropicModel,
        expectedProviders: ["anthropic"],
        wizard: {
          choiceId: "apiKey",
          choiceLabel: "API-ключ Anthropic",
          groupId: "anthropic",
          groupLabel: "$ Anthropic",
          groupSortKey: 3,
          groupHint: "Claude CLI + API-ключ",
