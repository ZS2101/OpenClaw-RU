...
const ARCEE_WIZARD_GROUP = {
  ...
  groupLabel: "$ Arcee AI",
  groupSortKey: 3,
  groupHint: "Прямой API или OpenRouter",
} as const;
...
function buildArceeAuthMethods() {
  return [
    ...
    createProviderApiKeyAuthMethod({
      ...
      promptMessage: "Введите API-ключ OpenRouter",
      ...
      wizard: {
        ...
        choiceHint: "Через OpenRouter (openrouter.ai)",
        ...ARCEE_WIZARD_GROUP,
      },
    }),
  ];
