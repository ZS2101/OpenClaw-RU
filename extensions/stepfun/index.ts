...
function createStepFunApiKeyMethod(params: {
  ...
  return createProviderApiKeyAuthMethod({
    ...
    wizard: {
      ...
      groupLabel: "¥ StepFun",
      groupSortKey: 2,
      groupHint: "Standard / Step Plan (Китай / Глобальный)",
    },
  });
}
    ...
    api.registerProvider({
      ...
      auth: [
        createStepFunApiKeyMethod({
          ...
          label: "API-ключ StepFun Standard (Китай)",
          hint: "Endpoint: api.stepfun.com/v1",
          region: "cn",
          promptMessage: "Введите API-ключ StepFun для китайских эндпоинтов",
          defaultModel: STEPFUN_DEFAULT_MODEL_REF,
          choiceId: "stepfun-standard-api-key-cn",
          choiceLabel: "API-ключ StepFun Standard (Китай)",
          choiceHint: "Эндпоинт: api.stepfun.com/v1",
          applyConfig: applyStepFunStandardConfigCn,
        }),
        createStepFunApiKeyMethod({
          providerId: STEPFUN_PROVIDER_ID,
          methodId: "standard-api-key-intl",
          label: "API-ключ StepFun Standard (Глобальный/Intl)",
          hint: "Endpoint: api.stepfun.ai/v1",
          region: "intl",
          promptMessage: "Введите API-ключ StepFun для глобальных эндпоинтов",
          defaultModel: STEPFUN_DEFAULT_MODEL_REF,
          choiceId: "stepfun-standard-api-key-intl",
          choiceLabel: "API-ключ StepFun Standard (Глобальный/Intl)",
          choiceHint: "Эндпоинт: api.stepfun.ai/v1",
    ...
    api.registerProvider({
      ...
      auth: [
        createStepFunApiKeyMethod({
          ...
          label: "API-ключ StepFun Step Plan (Китай)",
          hint: "Endpoint: api.stepfun.com/step_plan/v1",
          region: "cn",
          promptMessage: "Введите API-ключ StepFun для китайских эндпоинтов",
          defaultModel: STEPFUN_PLAN_DEFAULT_MODEL_REF,
          choiceId: "stepfun-plan-api-key-cn",
          choiceLabel: "API-ключ StepFun Step Plan (Китай)",
          choiceHint: "Эндпоинт: api.stepfun.com/step_plan/v1",
          applyConfig: applyStepFunPlanConfigCn,
        }),
        createStepFunApiKeyMethod({
          providerId: STEPFUN_PLAN_PROVIDER_ID,
          methodId: "plan-api-key-intl",
          label: "API-ключ StepFun Step Plan (Глобальный/Intl)",
          hint: "Endpoint: api.stepfun.ai/step_plan/v1",
          region: "intl",
          promptMessage: "Введите API-ключ StepFun для глобальных эндпоинтов",
          defaultModel: STEPFUN_PLAN_DEFAULT_MODEL_REF,
          choiceId: "stepfun-plan-api-key-intl",
          choiceLabel: "API-ключ StepFun Step Plan (Глобальный/Intl)",
          choiceHint: "Эндпоинт: api.stepfun.ai/step_plan/v1",
