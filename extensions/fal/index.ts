    ...
    api.registerProvider({
      ...
      auth: [
        createProviderApiKeyAuthMethod({
          ...
          envVar: "FAL_KEY",
          promptMessage: "Введите API-ключ fal",
          defaultModel: FAL_DEFAULT_IMAGE_MODEL_REF,
          expectedProviders: ["fal"],
          applyConfig: (cfg) => applyFalConfig(cfg),
          wizard: {
            choiceId: "fal-api-key",
            choiceLabel: "API-ключ fal",
            choiceHint: "API-ключ для генерации изображений и видео",
            groupId: "fal",
            groupLabel: "$ fal",
            groupSortKey: 3,
            groupHint: "Генерация изображений и видео",
